...
# On lance le simulateur de lien avec un délais de 50 ms et un écart de +/- 30 ms
./link_sim -p 1341 -P 2456 -d 50 -j 30 &> link.log &
link_pid=$!

# On lance le receiver et capture sa sortie standard
./../src/receiver -f test_out_delay.txt :: 2456  2> receiver.log &
receiver_pid=$!
